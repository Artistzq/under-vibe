...
**这个项目不教怎么写代码。** 写代码、解释代码，现在的 AI 都能做得很好——这部分完全可以交给 AI。Under Vibe 补的是 AI 帮不了你的那部分：看懂 AI 正在做什么、判断它给的方案可不可信、在它卡住或走偏时人工接管。VibeCoding 只是计算机体系的一小块，缺了这些底层知识，你很难独立做出一个完整、可靠的工程和产品。
