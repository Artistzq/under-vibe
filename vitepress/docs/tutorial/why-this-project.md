...
我是计算机科班出身。AI Agent 火起来以后，写代码、查文档、搭项目，交给 AI 做能省我很多时间。身边不少朋友没有计算机背景，用 AI 做点简单的事也很顺手：写个脚本处理表格，搭个简单网页，做个 PPT，常感叹"AI 太厉害了"。

但一旦开始做更复杂的事——比如做一个带登录和交互的动态网站，或写一个复杂数据处理的脚本——就卡住了。AI 给的代码，复制粘贴跑不起来；报错看不懂，只能把错误丢回给 AI，改了再跑还是报错，来回几次就放弃了；或者和 AI 反复对话，也得不到想要的结果。**问卡在哪，他说不清楚，只知道"AI 不好用了"。**

一开始我也不解，做了些调研才发现：问题不在 AI，而是他们缺了一些基本的概念和习惯。
...
> 如果你打算做个放手老板，可以不看这些 😌 不过以当前 AI 的能力，还很难在没人介入的情况下独立完成复杂任务；想认真 VibeCoding 的话，缺了这些知识，和 AI 沟通会非常费力。
...
正统学法从数据结构、操作系统、计算机网络、编译原理一路学下来，需要数学基础，需要大量时间，而且大部分内容写代码时根本用不上。
...
不追求覆盖所有知识点，但主要的概念和关键环节，都能在这里找到。
...
读完不会让你变成程序员，但跟 AI 合作时，会少很多"卡住了不知道怎么办"的时刻：
